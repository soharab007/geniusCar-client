  ...
  return (
    <div className="carousel w-full">
      ...
      {/* <div id="slide1" className="carousel-item relative w-full">
        ...
        <div className="absolute flex justify-between transform -translate-y-1/2 left-24 w-2/5 top-1/2">
          <p className="text-white text-xl">
            Lorem ipsum dolor sit, amet consectetur elit. Molestiae
            <br /> nam expedita, labore aliquam earum repellat nobis.
          </p>
        </div>
